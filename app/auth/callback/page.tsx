...
function getErrorMessage(): string | null {
    ...
    const description = pickFirst(searchParams.get('error_description'), hashParams.get('error_description'));
    ...
    return (
        ...
        >
            ...
            >
                ...
                <p style={{ margin: '0 0 24px', lineHeight: 1.6, color: '#4a4a4a' }}>{message.description}</p>
